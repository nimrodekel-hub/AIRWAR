...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    html: () => `
      ...
      <ul>
        <li>💥 <b>כלכלת חימושים</b> - שלח 4-5 כטב"מים בו-זמנית מאותו וקטור כדי למצות את התחמושת של Iron shield (8 מיירטים בלבד), ואז שלח את ה-Fighters יקרי-הערך.</li>
        ...
        <li>⛰ <b>גובה</b> - מסוקים (גובה 0.8) נמלטים מ-David's Sling ומ-Iron shield. Fighters בגובה 10 נמלטים מ-SA-8.</li>
      ...
      <ul>
        <li>🔍 <b>זום ומרכוז</b> - השתמש בכפתורים בפינה השמאלית-עליונה של המפה לתפעול המפה.</li>
