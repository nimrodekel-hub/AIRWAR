    ...
    html += `
      <div class="info-failure-list">
        ...
        <ul>
          ...
          <li><b>מחוץ לטווח היירוט הנומינלי</b> — האיום עבר במרחק יותר גדול מ-${c.maxRange} ק"מ מהסוללה</li>
        </ul>
      </div>
...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    html: () => `
      ...
      <div class="tip">🛡 <b>Iron shield ו-SA-8 = הגנה נקודתית נגד כטב"מים:</b> שתי הסוללות הקצרות-טווח תוכננו נגד מטרות קטנות, ולכן הן <u>עמידות לקנס הטווח של RCS נמוך</u> — הן שומרות על רוב טווחן מול כטב"מים (בניגוד לסוללות ארוכות-הטווח). הצב אותן מול צירי כטב"מים.</div>
  ...
  },
  {
    ...
    html: () => `
      ...
      <ul>
        ...
        <li><b>UAV (RCS 0.1)</b>: <b>רק ~56%</b> מהטווח (לרוב הסוללות). כטב"מים מאוד קשים לאיתור.</li>
      </ul>
      <div class="tip">🛡 <b>הגנה נקודתית נגד כטב"מים:</b> <b>SA-8 Gecko</b> ו-<b>Iron shield</b> הן מערכות הגנה נקודתית שתוכננו נגד מטרות קטנות — הן <u>עמידות לקנס ה-RCS</u> ושומרות על רוב טווחן מול כטב"מים (SA-8 מיירט כטב"ם עד ~25 ק"מ במקום ~17, Iron shield עד ~31). לכן הן הבחירה הנכונה נגד גלי כטב"מים, בעוד Patriot/קלע-דוד/Barak סובלות מהקנס המלא.</div>
  ...
  },
  {
    ...
    html: () => `
      ...
      <p>הציון <b>לא לינארי</b> במכוון — ביצוע בינוני לא נותן 50/100, אלא בערך 30. כל מרכיב מועלה בחזקה גבוהה שמענישה ביצוע חלקי.</p>
      <p><b>אתגר הגנה</b> נמדד לפי שני מרכיבים:</p>
      <ul>
        <li>🛡 <b>80 נק'</b> — אחוז הערך האסטרטגי שהוגן (יעדים שרדו × ערכם), בחזקת 1.8</li>
        <li>🎯 <b>20 נק'</b> — אחוז יירוטים מסך האיומים, בחזקת 1.5</li>
      </ul>
      <p><b>אתגר התקפה</b> נמדד לפי שני מרכיבים:</p>
      <ul>
        <li>💥 <b>70 נק'</b> — אחוז הנזק שגרמת לערך האסטרטגי, בחזקת 1.8</li>
        <li>🚀 <b>30 נק'</b> — אחוז האיומים שפרצו את ההגנה, בחזקת 1.5</li>
      </ul>

      <h4>⭐ XP לפי רמת קושי</h4>
      <p>ה-XP שתקבל תלוי בציון ובקושי המשימה. <b>הקשיים הגבוהים הם הדרך היחידה לטפס בדרגה</b> — משחקים קלים ובינוניים מזכים ב-XP סמלי בלבד:</p>
      <table>
        <tr><th>רמה</th><th>XP מקסימלי (ציון מושלם)</th></tr>
        <tr><td><b>קל</b></td><td>3 XP</td></tr>
        <tr><td><b>בינוני</b></td><td>15 XP</td></tr>
      ...
      <table>
        ...
        <tr><td>רב"ט</td><td>200</td></tr>
        <tr><td>סמל</td><td>500</td></tr>
        <tr><td>סמ"ר</td><td>1,100</td></tr>
        <tr><td>רס"ל</td><td>2,200</td></tr>
        <tr><td>רס"ר</td><td>4,000</td></tr>
        <tr><td>סג"מ</td><td>7,000</td></tr>
        <tr><td>סגן</td><td>12,000</td></tr>
        <tr><td>סרן</td><td>20,000</td></tr>
        <tr><td>רס"ן</td><td>32,000</td></tr>
        <tr><td>סא"ל</td><td>50,000</td></tr>
        <tr><td>אל"מ</td><td>75,000</td></tr>
        <tr><td>תא"ל</td><td>110,000</td></tr>
        <tr><td>אלוף</td><td>160,000</td></tr>
        <tr><td>רמטכ"ל</td><td>230,000</td></tr>
      </table>
